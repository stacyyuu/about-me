...
function questionOne () {
    let response = prompt ("Do I live in Washington?")
...
function questionTwo () {
    let response = prompt ("Do I like cats?")
        if (response.toLowerCase() === 'yes'|| response.toLowerCase() === 'y' ){
            alert('Correct!');
            correctCount++;
            return;
...
function questionThree () {
    let response = prompt ("Is purple my favorite color?")
        if (response.toLowerCase() === 'yes'|| response.toLowerCase() === 'y' ){
            alert('Correct!');
            correctCount++;
            return;
...
function questionFour () {
    let response = prompt ("Am I older than 30?")
...
function questionFive () {
    let response = prompt ("Do I have experience in the tech field?")
        if (response.toLowerCase() === 'no'|| response.toLowerCase() === 'n' ){
            alert('Correct!');
            correctCount++;
            return;
...
//     let response = prompt ('How many years have I been practicing as a Dental Hygienist? You have 4 guesses.')
//         if (response.toLowerCase() === 'no'|| response.toLowerCase() === 'n' ){
//             alert('Correct!');
//             correctCount++;
//             return;
...
function questionSeven () {
    for (let i = 5; i >= 0; i--){
        let response = prompt (`What is a country I want to visit?' You have ${i+1} guesses.`);
        if (toVisit.indexOf(response) != -1){  
            alert('Yes!');
            // response = prompt(`What is a country I want to visit? You have ${i+1} chances left to guess.`);
            correctCount++;
            return;
        } else {
